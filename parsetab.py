...
_lr_productions = [
  ...
  ('grammar_list -> comment_block','grammar_list',1,'p_grammar_list','Parser.py',72),
  ('grammar_list -> grammar_expression','grammar_list',1,'p_grammar_list','Parser.py',73),
  ('grammar_list -> token_expression','grammar_list',1,'p_grammar_list','Parser.py',74),
  ('grammar_list -> strict_expression','grammar_list',1,'p_grammar_list','Parser.py',75),
  ('grammar_list -> macro_expression','grammar_list',1,'p_grammar_list','Parser.py',76),
  ('grammar_list -> grammar_list grammar_expression','grammar_list',2,'p_grammar_list','Parser.py',77),
  ('grammar_list -> grammar_list token_expression','grammar_list',2,'p_grammar_list','Parser.py',78),
  ('grammar_list -> grammar_list strict_expression','grammar_list',2,'p_grammar_list','Parser.py',79),
  ('grammar_list -> grammar_list macro_expression','grammar_list',2,'p_grammar_list','Parser.py',80),
  ('grammar_list -> grammar_list comment_block','grammar_list',2,'p_grammar_list','Parser.py',81),
  ('comment_block -> COMMENT','comment_block',1,'p_comment_block','Parser.py',91),
  ('comment_block -> comment_block COMMENT','comment_block',2,'p_comment_block','Parser.py',92),
  ('grammar_expression -> LGRAMMAR_EXPRESSION productions_list','grammar_expression',2,'p_grammar_expression','Parser.py',103),
  ('grammar_expression -> LGRAMMAR_EXPRESSION','grammar_expression',1,'p_grammar_expression','Parser.py',104),
  ('token_expression -> LTOKEN_EXPRESSION productions_list','token_expression',2,'p_token_expression','Parser.py',114),
  ('strict_expression -> LSTRICT_EXPRESSION productions_list','strict_expression',2,'p_strict_expression','Parser.py',120),
  ('macro_expression -> LMACRO_EXPRESSION productions_list','macro_expression',2,'p_macro_expression','Parser.py',126),
  ('productions_list -> production','productions_list',1,'p_productions_list','Parser.py',132),
  ('productions_list -> productions_list ALTERNATIVE_SYMBOL production','productions_list',3,'p_productions_list','Parser.py',133),
  ('xor_productions_list -> production','xor_productions_list',1,'p_xor_productions_list','Parser.py',143),
  ('xor_productions_list -> xor_productions_list ALTERNATIVE_SYMBOL production','xor_productions_list',3,'p_xor_productions_list','Parser.py',144),
  ('t_symbol_production -> OPEN_SQUARE_BRACKET T_SYMBOL CLOSE_SQUARE_BRACKET','t_symbol_production',3,'p_t_symbol_production','Parser.py',154),
  ('t_symbol_production -> OPEN_SQUARE_BRACKET REPETITION_SYMBOL CLOSE_SQUARE_BRACKET','t_symbol_production',3,'p_t_symbol_production','Parser.py',155),
  ('t_symbol_production -> OPEN_SQUARE_BRACKET ALTERNATIVE_SYMBOL CLOSE_SQUARE_BRACKET','t_symbol_production',3,'p_t_symbol_production','Parser.py',156),
  ('t_symbol_production -> T_SYMBOL','t_symbol_production',1,'p_t_symbol_production','Parser.py',157),
  ('production_element -> OPEN_SQUARE_BRACKET NT_SYMBOL CLOSE_SQUARE_BRACKET','production_element',3,'p_production_element','Parser.py',169),
  ('production_element -> NT_SYMBOL REPETITION_SYMBOL','production_element',2,'p_production_element','Parser.py',170),
  ('production_element -> t_symbol_production REPETITION_SYMBOL','production_element',2,'p_production_element','Parser.py',171),
  ('production_element -> OPEN_SQUARE_BRACKET CLOSE_SQUARE_BRACKET','production_element',2,'p_production_element','Parser.py',172),
  ('production_element -> NT_SYMBOL','production_element',1,'p_production_element','Parser.py',173),
  ('production_element -> t_symbol_production','production_element',1,'p_production_element','Parser.py',174),
  ('production -> production_element','production',1,'p_production','Parser.py',194),
  ('production -> production production_element','production',2,'p_production','Parser.py',195),
  ('production -> OPEN_PARENTHESIS xor_productions_list CLOSE_PARENTHESIS','production',3,'p_production','Parser.py',196),
  ('production -> OPEN_PARENTHESIS production CLOSE_PARENTHESIS','production',3,'p_production','Parser.py',197),
  ('production -> production OPEN_PARENTHESIS production CLOSE_PARENTHESIS','production',4,'p_production','Parser.py',198),
  ('production -> production OPEN_PARENTHESIS xor_productions_list CLOSE_PARENTHESIS','production',4,'p_production','Parser.py',199),
  ('production -> OPEN_PARENTHESIS production CLOSE_PARENTHESIS production','production',4,'p_production','Parser.py',200),
  ('production -> OPEN_PARENTHESIS xor_productions_list CLOSE_PARENTHESIS production','production',4,'p_production','Parser.py',201),
  ('production -> OPEN_PARENTHESIS production CLOSE_PARENTHESIS REPETITION_SYMBOL','production',4,'p_production','Parser.py',202),
  ('production -> production OPEN_PARENTHESIS production CLOSE_PARENTHESIS REPETITION_SYMBOL','production',5,'p_production','Parser.py',203),
]
